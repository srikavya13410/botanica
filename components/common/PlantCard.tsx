...
const PlantCard: React.FC<PlantCardProps> = ({ plant, onAdd, showAddButton = false, onLearnMore, isAdded = false }) => {
    ...
    <div className="bg-white rounded-lg shadow-lg overflow-hidden transform hover:scale-105 transition-transform duration-300">
      <div className="relative w-full h-48 bg-gray-100">
        {plant.isLoadingImage ? (
          ...
          plant.imageUrl && <img src={plant.imageUrl} alt={plant.name} className="w-full h-full object-cover" />
        )}
      </div>
      <div className="p-4">
        {plant.nickname ? (
